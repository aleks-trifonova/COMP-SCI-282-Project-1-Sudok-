 class test2 {
    ...
    public static void main(String[] args) {
        ...
        prog1 p, p1;
        System.out.println("Author: " + prog1.myName());
        for (int i = 0; i < 9; i++) {
            p = new prog1(s[i]);
            System.out.print("#" + i + ": ");
            if (!p.isValid()) {
        ...
        p = new prog1(s[s.length-2]);
        p1 = new prog1(p);
        p.solve();
        if (p1.toString2().compareTo(constructorAnswers[0]) == 0)
            System.out.println(" Answers match.   ");
        else
            System.out.println("   *** Copy Constructor Problem with copied prog1  ***   ");
        if (p.toString2().compareTo(constructorAnswers[1]) == 0)
            System.out.println(" Answers match.   ");
        else
            System.out.println("   *** Copy Constructor Problem with original prog1  ***   ");
        p = new prog1(s[s.length-1]);
        p1 = new prog1(p);
        p.solve();
